...
$config['baseurl'] = "http://localhost.me"; //  Must be a valid URL to prevent issues with loading images and templates.
$config['page_title'] = "Simple Register"; // The title of your website as displayed in the browser tab.
$config['language'] = "german"; // The default language for your website.
...
$config['patch_location'] = ''; // URL to download the patch if available. Leave empty if not applicable.
...
$config['vote_system'] = false; // Set to true to enable the vote system.
...
$config['captcha_type'] = 4; // Options: 0 (Image Captcha), 1 (HCaptcha), 2 (ReCaptcha v2), or >2 (Disable captcha).
